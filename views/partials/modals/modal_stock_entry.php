      ...
      <form id="formStockEntry" onsubmit="return false;">
        ...
        <div class="modal-body">
          ...
          <div class="mb-2">
            ...
            <textarea name="notes" class="form-control" rows="2" placeholder="Ej. compra, producción"></textarea>
          </div>
        </div>
        <div class="modal-footer">
          <button class="btn btn-secondary" data-bs-dismiss="modal" type="button">Cancelar</button>
          <!-- type="button" para evitar submit nativo -->
          <button class="btn btn-success js-submit-entry" type="button" data-action="entry">
