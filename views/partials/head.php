...
<head>
    ...
    <link rel="stylesheet" href="<?php echo BASE_URL; ?>assets/css/bootstrap-5.3.7-dist/bootstrap.min.css">
    <!-- Enlace a la hoja de estilos de Bootstrap para aplicar sus clases y estructura -->

    <link rel="stylesheet" href="<?php echo BASE_URL; ?>assets/bootstrap-icons-1.13.1/bootstrap-icons.min.css">
